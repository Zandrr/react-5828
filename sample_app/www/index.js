...
var CreateBoard = React.createClass({displayName: "CreateBoard",

	render: function() {
		return (
			React.createElement("div", {style: tileStyle}
      		)
			);
	}
});
...
React.render(React.createElement(Test, null), document.querySelector('#app'));

},{"./create_board":1,"react":158}],3:[function(require,module,exports){
