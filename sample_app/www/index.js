...
React.render(React.createElement(TodoList, null), document.querySelector('#app'));

},{"./todo_list":3,"react":159}],2:[function(require,module,exports){
var React = require('react');
	...
	render: function(){
		return (
			React.createElement("div", null, 
				...
				React.createElement("input", {id: "listApp", type: "text", ref: "inputAdd"}), 
				React.createElement("button", {type: "submit", onClick: this.addItem}, "Add")
			)
		);
	}
});
...
},{"./todo_items":2,"react":159}],4:[function(require,module,exports){
